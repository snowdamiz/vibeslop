      ...
      <div className="overflow-y-auto flex-1 bg-background">
        <div className="p-6">
          ...
          >
            ...
            {/* Path Selection Step */}
            {flowPath === 'selection' && (
              <div className="space-y-8 py-4 -mx-6">
                <div className="text-center space-y-2 mb-6">
                  <h2 className="text-2xl font-bold tracking-tight">Create a Project Post</h2>
                  <p className="text-muted-foreground text-sm max-w-[320px] mx-auto">
                    Choose how you'd like to showcase your work
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="group relative w-full p-5 rounded-xl border border-primary/20 bg-primary/[0.02] hover:bg-primary/[0.04] hover:border-primary/40 transition-all duration-200 text-left"
                  >
                    <div className="flex gap-4">
                      <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 transition-transform group-hover:scale-105">
                        <Sparkles className="w-5 h-5 text-primary" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <h3 className="font-semibold text-[15px]">Generate from GitHub</h3>
                          <span className="text-[10px] font-bold px-1.5 py-0.5 bg-primary text-primary-foreground rounded uppercase tracking-wider">
                            Recommended
                          </span>
                        </div>
                  ...
                  <button
                    ...
                    className="group relative w-full p-5 rounded-xl border border-border bg-card hover:border-muted-foreground/20 hover:bg-muted/10 transition-all duration-200 text-left"
                  >
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold text-[15px] mb-1">Create Manually</h3>
                        <p className="text-sm text-muted-foreground mb-4">
            ...
            {flowPath === 'manual' && currentStep === 4 && (
              <div className="space-y-5">
                <div className="text-center space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">Add highlights or timeline (optional)</p>
                </div>
